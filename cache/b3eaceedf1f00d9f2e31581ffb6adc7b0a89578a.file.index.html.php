<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:41:30
         compiled from "application/views\izin_pending_internasional/baru/index.html" */ ?>
<?php /*%%SmartyHeaderCode:128185600dbfa7dc7a1-37162098%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3eaceedf1f00d9f2e31581ffb6adc7b0a89578a' => 
    array (
      0 => 'application/views\\izin_pending_internasional/baru/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '128185600dbfa7dc7a1-37162098',
  'function' => 
  array (
  ),
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/baru/index/').($_smarty_tpl->getVariable('detail')->value['izin_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/baru/edit_process');?>
" method="post">
