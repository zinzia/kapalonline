<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:21:04
         compiled from "application/views\izin_pending_internasional/perubahan/index.html" */ ?>
<?php /*%%SmartyHeaderCode:255905600e540c3e326-73507434%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '278fb21c70149acb539efe18d9cb7067f811fc73' => 
    array (
      0 => 'application/views\\izin_pending_internasional/perubahan/index.html',
      1 => 1442894815,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '255905600e540c3e326-73507434',
  'function' => 
  array (
  ),
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/perubahan/index/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/perubahan/edit_process');?>
" method="post">
