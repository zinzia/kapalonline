<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:22:12
         compiled from "application/views\izin_internasional/frekuensi_add/form_mixed.html" */ ?>
<?php /*%%SmartyHeaderCode:239245600e5845b9ec2-38226578%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '35b95e5f51425eef2905427684e4ee638d3417f4' => 
    array (
      0 => 'application/views\\izin_internasional/frekuensi_add/form_mixed.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '239245600e5845b9ec2-38226578',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/frekuensi_add/rute_data_search_process');?>
" method="post">
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/frekuensi_add/rute_add_process_mixed');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
    <input type="hidden" name="izin_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('rute')->value['izin_id'])===null||$tmp==='' ? '' : $tmp);?>
