<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:20:47
         compiled from "application/views\izin_internasional/perubahan/review.html" */ ?>
<?php /*%%SmartyHeaderCode:244805600e52f23d222-63685564%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '26a453a76c8a1dfb9998654608a929fbd2261b7c' => 
    array (
      0 => 'application/views\\izin_internasional/perubahan/review.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '244805600e52f23d222-63685564',
  'function' => 
  array (
  ),
...
"><b>Step 4</b><br />File Attachment</a>
        ...
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perubahan/review/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<div class="navigation">
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perubahan/list_files/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perubahan/send_process');?>
" method="post">
