<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:54:15
         compiled from "application/views\izin_internasional/perpanjangan/list.html" */ ?>
<?php /*%%SmartyHeaderCode:15825600def7bd3a15-87045153%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7c6504909cbf93ae25b5d4374356e6d0024e929d' => 
    array (
      0 => 'application/views\\izin_internasional/perpanjangan/list.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15825600def7bd3a15-87045153',
  'function' => 
  array (
  ),
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/index/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><b>Step 1</b><br />Data Permohonan</a>
        </li>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/list_rute/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<div class="navigation">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['izin_rute_end'];?>
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/index/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<br /><?php echo ((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins'), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins'),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins')));?>
            ...
            <?php if ($_smarty_tpl->getVariable('rowspan')->value<=1){?>
            <td align="center">
                <?php echo $_smarty_tpl->getVariable('selected_perpanjangan')->value[$_smarty_tpl->tpl_vars['data']->value['kode_frekuensi']];?>

                <?php if ($_smarty_tpl->getVariable('rute_selected')->value[$_smarty_tpl->tpl_vars['data']->value['kode_frekuensi']]!='1'){?>
                <?php if ($_smarty_tpl->getVariable('selected_perpanjangan')->value[$_smarty_tpl->tpl_vars['data']->value['kode_frekuensi']]=='0'){?>
                <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/perpanjangan/rute_add_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['kode_frekuensi']));?>
" class="button-edit">Perpanjang</a>
                <?php }else{ ?>
                <b>Telah Diperpanjang</b>                
                <?php }?>
                <?php }else{ ?>
                <b>Selected</b>
                <?php }?>
...
<br /><?php echo ((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins'), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins'),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins')));?>
        ...
        <?php if ($_smarty_tpl->getVariable('rowspan')->value<=1){?>
        <td align="center">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/perpanjangan/rute_data/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id']));?>
" class="button-edit">Edit</a>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/perpanjangan/rute_delete/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id']));?>
...
X</b>
            <?php }?>
            <?php if ($_smarty_tpl->getVariable('total_existing')->value['frekuensi']<$_smarty_tpl->getVariable('total')->value['frekuensi']){?>
            <b style="color: red;">+<?php echo $_smarty_tpl->getVariable('total')->value['frekuensi']-$_smarty_tpl->getVariable('total_existing')->value['frekuensi'];?>
X</b>
            <?php }?>
            <?php }?>
        </td>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perpanjangan/list_rute_process');?>
" method="post">
...
">
    <table class="table-form" width='100%'>
        <tr class="submit-box">
            <td colspan="2">
                <?php if ($_smarty_tpl->getVariable('total')->value['frekuensi']==$_smarty_tpl->getVariable('total_existing')->value['frekuensi']){?>
