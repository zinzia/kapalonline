<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:21:35
         compiled from "application/views\izin_domestik/frekuensi_add/index.html" */ ?>
<?php /*%%SmartyHeaderCode:22795600e55f4f7214-54335220%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71deb5fad6efea58eb8d968f399ceac52ef1b9fc' => 
    array (
      0 => 'application/views\\izin_domestik/frekuensi_add/index.html',
      1 => 1441883440,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22795600e55f4f7214-54335220',
  'function' => 
  array (
  ),
    ...
    $(document).ready(function() {
        ...
        $('#combobox').change(function() {
            ...
            $.ajax({
                ...
                url: '<?php echo $_smarty_tpl->getVariable('config')->value->site_url("izin_domestik/frekuensi_add/get_rute_by_kode_izin");?>
',
                complete: function() {
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_domestik/frekuensi_add/index/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_domestik/frekuensi_add/edit_process');?>
" method="post">
