<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:16:24
         compiled from "application/views\task/izin_staff_int/perpanjangan.html" */ ?>
<?php /*%%SmartyHeaderCode:72305600e4286f56a6-63241993%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01a907abb1030c0aab48d743e52527af41ad67e8' => 
    array (
      0 => 'application/views\\task/izin_staff_int/perpanjangan.html',
      1 => 1441883427,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '72305600e4286f56a6-63241993',
  'function' => 
  array (
  ),
...
<table class="table-form" width="100%">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['airlines_iata_cd'];?>
    ...
    <tr>
        <td width='20%'>
            <span style="text-decoration: underline;">Masa Berlaku Sekarang</span><br /><i>Expired Date Existing</i>
        </td>
        <td width='30%'><b style="color: red;"><?php echo ((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date((($tmp = @$_smarty_tpl->getVariable('masa_berlaku_sebelumnya')->value)===null||$tmp==='' ? '' : $tmp)), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date((($tmp = @$_smarty_tpl->getVariable('masa_berlaku_sebelumnya')->value)===null||$tmp==='' ? '' : $tmp)),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date((($tmp = @$_smarty_tpl->getVariable('masa_berlaku_sebelumnya')->value)===null||$tmp==='' ? '' : $tmp))));?>
</b></td>
        <td width='20%'>
            <span style="text-decoration: underline;">Masa Berlaku Perpanjangan</span><br /><i>Expired Date Now</i>
        </td>
        <td width='30%'><b style="color: blue;"><?php echo ((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date((($tmp = @$_smarty_tpl->getVariable('masa_berlaku_perpanjangan')->value)===null||$tmp==='' ? '' : $tmp)), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date((($tmp = @$_smarty_tpl->getVariable('masa_berlaku_perpanjangan')->value)===null||$tmp==='' ? '' : $tmp)),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date((($tmp = @$_smarty_tpl->getVariable('masa_berlaku_perpanjangan')->value)===null||$tmp==='' ? '' : $tmp))));?>
</b></td>
    </tr>
    <tr>
        <td>
...
<div id="table-data" style="margin: 0 0 5px 0; padding: 10px; border: 1px solid #ddd; font-weight: bold; font-size: 12px; font-family: helvetica;">
    <h4>Data Izin Rute Yang Akan Diperpanjang</h4>
...
<div class="navigation" style="background-color: #eee; padding: 10px;">
    <div class="navigation-button" style="width: 850px;">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('task/izin_staff_int/preview_perpanjangan/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
