<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:31:16
         compiled from "application/views\izin_internasional/migrasi/list_izin_data.html" */ ?>
<?php /*%%SmartyHeaderCode:101185600d9946bafa9-16016573%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cabb42413da0b3cea4009f6baadcc2b74663a40d' => 
    array (
      0 => 'application/views\\izin_internasional/migrasi/list_izin_data.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '101185600d9946bafa9-16016573',
  'function' => 
  array (
  ),
...
<div class="navigation">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['izin_rute_end'];?>
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/migrasi/list_rute/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
X</td>
        ...
        <td align="center">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((((('izin_internasional/migrasi/izin_data_delete_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['rute_id']));?>
...
X</b></td>
        <td align="center"><b><?php echo (($tmp = @((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->getVariable('rute')->value['izin_start_date'],'ins'), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->getVariable('rute')->value['izin_start_date'],'ins'),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->getVariable('rute')->value['izin_start_date'],'ins'))))===null||$tmp==='' ? '-' : $tmp);?>
</b></td>
        <td align="center"><b><?php echo (($tmp = @((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->getVariable('rute')->value['izin_expired_date'],'ins'), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->getVariable('rute')->value['izin_expired_date'],'ins'),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->getVariable('rute')->value['izin_expired_date'],'ins'))))===null||$tmp==='' ? '-' : $tmp);?>
</b></td>
        <td align="center"></td>
    </tr>
</table>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/migrasi/form_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
<?php if ($_smarty_tpl->getVariable('rute')->value['is_used_score']==1){?>
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/migrasi/form_mixed.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/migrasi/form_non_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>