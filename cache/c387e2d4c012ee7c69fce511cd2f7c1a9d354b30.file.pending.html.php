<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:12:34
         compiled from "application/views\member/payment_izin/pending.html" */ ?>
<?php /*%%SmartyHeaderCode:294855600d532a24d06-15277285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c387e2d4c012ee7c69fce511cd2f7c1a9d354b30' => 
    array (
      0 => 'application/views\\member/payment_izin/pending.html',
      1 => 1441883440,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '294855600d532a24d06-15277285',
  'function' => 
  array (
  ),
...
" class="active">WAITING FOR PAYMENT</a></li>
...
<div class="sub-content">
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
    ...
    <div class="search-box">
        ...
        <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('member/payment_izin/proses_cari_pending');?>
" method="post">
...
resource/doc/images/icon/bad_mark.png" alt="" style="height: 14px;" />
                <?php }else{ ?>
                <img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
resource/doc/images/icon/icon.waiting.png" alt="" style="height: 14px;" />
                <?php }?>
            </td>
            <td align="center">
