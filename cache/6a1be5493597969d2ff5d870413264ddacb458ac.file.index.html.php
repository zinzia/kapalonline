<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:46:37
         compiled from "application/views\izin_internasional/penundaan/index.html" */ ?>
<?php /*%%SmartyHeaderCode:87285600dd2d28a9e6-38924752%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a1be5493597969d2ff5d870413264ddacb458ac' => 
    array (
      0 => 'application/views\\izin_internasional/penundaan/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '87285600dd2d28a9e6-38924752',
  'function' => 
  array (
  ),
    ...
    $(document).ready(function () {
        ...
        $('#combobox').change(function () {
            ...
            $.ajax({
                ...
                url: '<?php echo $_smarty_tpl->getVariable('config')->value->site_url("izin_internasional/penundaan/get_rute_by_kode_izin");?>
',
                complete: function () {
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/penundaan/index/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/penundaan/edit_process');?>
" method="post">
