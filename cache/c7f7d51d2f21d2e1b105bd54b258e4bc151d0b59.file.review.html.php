<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:47:42
         compiled from "application/views\izin_pending_internasional/penghentian/review.html" */ ?>
<?php /*%%SmartyHeaderCode:231735600eb7e7349f5-26918115%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7f7d51d2f21d2e1b105bd54b258e4bc151d0b59' => 
    array (
      0 => 'application/views\\izin_pending_internasional/penghentian/review.html',
      1 => 1442900545,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '231735600eb7e7349f5-26918115',
  'function' => 
  array (
  ),
...
"><b>Step 3</b><br />File Attachment</a>
        ...
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/penghentian/review/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<div class="navigation">
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/penghentian/list_files/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/penghentian/send_process');?>
" method="post">
