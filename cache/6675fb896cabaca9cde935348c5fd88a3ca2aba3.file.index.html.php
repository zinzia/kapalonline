<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:42:23
         compiled from "application/views\izin_internasional/perpanjangan/index.html" */ ?>
<?php /*%%SmartyHeaderCode:46475600dc2f2c29b3-45568322%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6675fb896cabaca9cde935348c5fd88a3ca2aba3' => 
    array (
      0 => 'application/views\\izin_internasional/perpanjangan/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '46475600dc2f2c29b3-45568322',
  'function' => 
  array (
  ),
    ...
    $(document).ready(function() {
        ...
        $('#combobox').change(function() {
            ...
            $.ajax({
                ...
                url: '<?php echo $_smarty_tpl->getVariable('config')->value->site_url("izin_internasional/perpanjangan/get_rute_by_kode_izin");?>
',
                complete: function() {
                ...
                success: function(result) {
                    ...
                    $('#str_season_cd').val(data.izin_season_next);
                }
            });
        });
        // date picker
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perpanjangan/edit_process');?>
" method="post">
