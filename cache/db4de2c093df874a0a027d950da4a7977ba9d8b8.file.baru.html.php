<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:44:19
         compiled from "application/views\task/izin_kasubdit_int/baru.html" */ ?>
<?php /*%%SmartyHeaderCode:169555600dca3059755-06226495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db4de2c093df874a0a027d950da4a7977ba9d8b8' => 
    array (
      0 => 'application/views\\task/izin_kasubdit_int/baru.html',
      1 => 1441883427,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169555600dca3059755-06226495',
  'function' => 
  array (
  ),
...
<table class="table-input" width="100%">
    <tr style="font-weight: bold;">
        <td width="33%" style="vertical-align: top;">
            <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('task/izin_kasubdit_int/airlines_notes_process/');?>
" method="post">
                <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
...
?>
 ...
 / <?php echo $_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['note_date']);?>
        ...
        <td width="33%" style="vertical-align: top;">
            <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('task/izin_kasubdit_int/catatan_process/');?>
" method="post">
                <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
...
?>
 ...
 / <?php echo $_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['mdd_finish']);?>
        ...
        <td width="33%" style="vertical-align: top;">
            <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('task/izin_kasubdit_int/memo_process/');?>
" method="post">
                <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
                <input type="hidden" name="process_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['process_id'])===null||$tmp==='' ? '' : $tmp);?>
...
?>
                        <li style="border-bottom: 1px solid #ddd;">
                            <span><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_kasubdit_int/delete_memo_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['memo_id']));?>
...
<table class="table-input" width="100%">
    <tr style="font-weight: bold;">
        <td width="40%" style="vertical-align: top;">
            <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('task/izin_kasubdit_int/telaah_process/');?>
...
<div class="navigation" style="background-color: #eee; padding: 10px;">
    <div class="navigation-button" style="width: 850px;">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('task/izin_kasubdit_int/preview_baru/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
resource/doc/images/icon/icon.normal.png" alt="" /> Preview Surat</a></li>
            ...
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_kasubdit_int/back_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->getVariable('detail')->value['process_id']));?>
...
resource/doc/images/icon/arrow-left.png" alt="" /> Kirim ke <?php echo $_smarty_tpl->getVariable('prev')->value['role_nm'];?>
            ...
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_kasubdit_int/reject_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->getVariable('detail')->value['process_id']));?>
...
resource/doc/images/icon/icon.failed.png" alt="" /> Tolak Semua Permohonan</a></li>
            ...
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_kasubdit_int/send_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->getVariable('detail')->value['process_id']));?>
