<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:55:03
         compiled from "application/views\izin_internasional/perpanjangan/list_slot.html" */ ?>
<?php /*%%SmartyHeaderCode:212715600df270e9704-54688742%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c0c3fea2b6b3e9c2d8347ba6909c16c0cb40c190' => 
    array (
      0 => 'application/views\\izin_internasional/perpanjangan/list_slot.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '212715600df270e9704-54688742',
  'function' => 
  array (
  ),
...
"><b>Step 2</b><br />Data Rute Penerbangan</a>
        ...
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/list_slot/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<div class="navigation">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['izin_rute_end'];?>
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/list_rute/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
resource/doc/images/icon/back-icon.png" alt="" />Previous Step</a></li>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/slot_add/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<br />
        ...
        <td align="center" style="font-size: 10px;">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/perpanjangan/slot_download/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['slot_id']));?>
"><?php echo $_smarty_tpl->tpl_vars['data']->value['slot_file_name'];?>
</a>
        </td>
        <td align="center">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/perpanjangan/slot_edit/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['slot_id']));?>
" class="button-edit">Edit</a>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/perpanjangan/slot_delete/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['slot_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perpanjangan/list_slot_process');?>
" method="post">
