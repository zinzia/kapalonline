<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:23:48
         compiled from "application/views\izin_pending_internasional/frekuensi_add/index.html" */ ?>
<?php /*%%SmartyHeaderCode:121125600e5e4e283b1-06806008%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dfdd180a3d9a52b5365a647e6319a5591271232d' => 
    array (
      0 => 'application/views\\izin_pending_internasional/frekuensi_add/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '121125600e5e4e283b1-06806008',
  'function' => 
  array (
  ),
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/frekuensi_add/index/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/frekuensi_add/edit_process');?>
" method="post">
