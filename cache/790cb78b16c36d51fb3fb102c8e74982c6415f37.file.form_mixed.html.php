<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:31:16
         compiled from "application/views\izin_internasional/migrasi/form_mixed.html" */ ?>
<?php /*%%SmartyHeaderCode:225995600d9947cc6a5-57923746%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '790cb78b16c36d51fb3fb102c8e74982c6415f37' => 
    array (
      0 => 'application/views\\izin_internasional/migrasi/form_mixed.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '225995600d9947cc6a5-57923746',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/migrasi/rute_data_search_process');?>
" method="post">
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/migrasi/rute_add_process_mixed');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
    <input type="hidden" name="izin_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('rute')->value['izin_id'])===null||$tmp==='' ? '' : $tmp);?>
