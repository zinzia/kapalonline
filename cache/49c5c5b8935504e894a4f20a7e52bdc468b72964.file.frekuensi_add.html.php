<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:23:39
         compiled from "application/views\task/izin_staff_int/frekuensi_add.html" */ ?>
<?php /*%%SmartyHeaderCode:216235600e5dbb33222-78223151%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '49c5c5b8935504e894a4f20a7e52bdc468b72964' => 
    array (
      0 => 'application/views\\task/izin_staff_int/frekuensi_add.html',
      1 => 1441883427,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '216235600e5dbb33222-78223151',
  'function' => 
  array (
  ),
...
<table class="table-form" width="100%">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['airlines_iata_cd'];?>
    ...
    <tr>
        ...
        <td style="color: blue; font-weight: bold;">
            <?php echo ((mb_detect_encoding((($tmp = @$_smarty_tpl->getVariable('detail')->value['kode_izin'])===null||$tmp==='' ? '' : $tmp), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper((($tmp = @$_smarty_tpl->getVariable('detail')->value['kode_izin'])===null||$tmp==='' ? '' : $tmp),SMARTY_RESOURCE_CHAR_SET) : strtoupper((($tmp = @$_smarty_tpl->getVariable('detail')->value['kode_izin'])===null||$tmp==='' ? '' : $tmp)));?>
 ...
 / <?php echo ((mb_detect_encoding((($tmp = @$_smarty_tpl->getVariable('detail')->value['izin_rute_end'])===null||$tmp==='' ? '' : $tmp), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper((($tmp = @$_smarty_tpl->getVariable('detail')->value['izin_rute_end'])===null||$tmp==='' ? '' : $tmp),SMARTY_RESOURCE_CHAR_SET) : strtoupper((($tmp = @$_smarty_tpl->getVariable('detail')->value['izin_rute_end'])===null||$tmp==='' ? '' : $tmp)));?>
        ...
        <td style="color: blue; font-weight: bold;">
            <?php echo $_smarty_tpl->getVariable('izin')->value['frekuensi'];?>
X
        </td>
    </tr>   
    <tr>
...
">
    <table class="table-view" width="100%">
        <tr>
            ...
            <th width="8%">Nomor Penerbangan</th>
...
X</td>
            <td align="center"><?php echo $_smarty_tpl->tpl_vars['data']->value['start_date'];?>
<br /><?php echo $_smarty_tpl->tpl_vars['data']->value['end_date'];?>
</td>
...
">
        ...
        <?php } ?>
        <tr>
            <td colspan="8" align="right">Jumlah Frekuensi / Minggu Yang Ditambahkan</td>
            <td align="center"><b><?php echo (($tmp = @$_smarty_tpl->getVariable('tot_frek')->value)===null||$tmp==='' ? 0 : $tmp);?>
X</b></td>
            <td rowspan="2" colspan="2" align="center"><input type="submit" value="Simpan"/></td>
        </tr>
        <tr>
            <td colspan="8" align="right">Jumlah Frekuensi / Minggu Keseluruhan</td>
            <td align="center"><b style="text-decoration: underline; color: red;"><?php echo $_smarty_tpl->getVariable('tot_frek')->value+$_smarty_tpl->getVariable('izin')->value['frekuensi'];?>
X</b></td>
        </tr>
    </table>
</form>
...
<table class="table-view" width="100%">
    ...
    <tr>
        ...
        <th width="20%" align="center">Rute</th>
        <th width="15%" align="center">Operating Flight No</th>
        <th width="15%" align="center">Marketing Flight No</th>
        <th width="15%" align="center">Airlines</th>
        <th width="10%" align="center">ETD</th>
...
.</td>
        ...
        <td align="center"><?php echo $_smarty_tpl->tpl_vars['data']->value['airlines_nm'];?>
</td>
    ...
    <?php }} else { ?>
    <tr>
        <td colspan="7">Data codeshare belum diinputkan!</td>
    </tr>
    <?php } ?>
</table>
...
<div class="navigation" style="background-color: #eee; padding: 10px;">
    <div class="navigation-button" style="width: 850px;">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('task/izin_staff_int/preview_frekuensi_add/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
