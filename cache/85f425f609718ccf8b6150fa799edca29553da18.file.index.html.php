<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:08:40
         compiled from "application/views\izin_internasional/perubahan/index.html" */ ?>
<?php /*%%SmartyHeaderCode:272405600d448604409-02301540%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85f425f609718ccf8b6150fa799edca29553da18' => 
    array (
      0 => 'application/views\\izin_internasional/perubahan/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '272405600d448604409-02301540',
  'function' => 
  array (
  ),
    ...
    $(document).ready(function() {
        ...
        $('#combobox').change(function() {
            ...
            $.ajax({
                ...
                url: '<?php echo $_smarty_tpl->getVariable('config')->value->site_url("izin_internasional/perubahan/get_rute_by_kode_izin");?>
',
                complete: function() {
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perubahan/edit_process');?>
" method="post">
...
" id="input_masa_berlaku" />
    <table class="table-form" width="100%">
        ...
        <tr>
            <td>
                <span>Izin Perihal</span>
            </td>
            <td>
                <input type="text" name="izin_perihal" size="35" maxlength="50" value="<?php echo ((mb_detect_encoding((($tmp = @$_smarty_tpl->getVariable('result')->value['izin_perihal'])===null||$tmp==='' ? 'DALAM NEGERI' : $tmp), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper((($tmp = @$_smarty_tpl->getVariable('result')->value['izin_perihal'])===null||$tmp==='' ? 'DALAM NEGERI' : $tmp),SMARTY_RESOURCE_CHAR_SET) : strtoupper((($tmp = @$_smarty_tpl->getVariable('result')->value['izin_perihal'])===null||$tmp==='' ? 'DALAM NEGERI' : $tmp)));?>
" style="font-weight: bold;" />                
            </td>
             <td colspan="2" width='20%'>                
                 <em style="color: red;">Akan dijadikan acuan untuk merubah judul pengajuan perubahan misal menjadi : <br/> <strong>Perubahan Rute Penerbangan Berdasarkan <u>Notam</u></strong> </em>
            </td>
        </tr> 
        <tr>
            <td width='20%'>
