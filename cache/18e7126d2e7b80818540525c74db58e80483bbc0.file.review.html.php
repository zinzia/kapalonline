<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:57:38
         compiled from "application/views\izin_internasional/perpanjangan/review.html" */ ?>
<?php /*%%SmartyHeaderCode:247415600dfc2c1ea36-35160979%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '18e7126d2e7b80818540525c74db58e80483bbc0' => 
    array (
      0 => 'application/views\\izin_internasional/perpanjangan/review.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '247415600dfc2c1ea36-35160979',
  'function' => 
  array (
  ),
...
" class="normal"><b>Step 3</b><br />Slot Clearance</a>
        ...
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/list_files/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><b>Step 4</b><br />File Attachment</a>
        </li>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/review/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<div class="navigation">
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/perpanjangan/list_files/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perpanjangan/send_process');?>
" method="post">
...
X</b>
    ...
    <div style="margin: 0 0 5px 0; padding: 10px; border: 1px solid #ddd; font-size: 11px; font-family: helvetica;">
        <h3 style="font-family: helvetica; font-size: 12px;">Data Rute Penerbangan Yang Akan Diperpanjang</h3>
        <table class="table-view" width="100%">
            <tr style="font-weight: bold;">
                <td width="4%" align='center'>No</td>
                <td width="10%" align='center'>Rute</td>
