<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:19:21
         compiled from "application/views\izin_internasional/perubahan/form_mixed.html" */ ?>
<?php /*%%SmartyHeaderCode:189755600e4d9ddc4e8-15051554%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e79118f482130916a5efd1b4664aba67a6a7f98f' => 
    array (
      0 => 'application/views\\izin_internasional/perubahan/form_mixed.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '189755600e4d9ddc4e8-15051554',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perubahan/rute_data_search_process');?>
" method="post">
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perubahan/rute_add_process_mixed');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
    <input type="hidden" name="izin_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('rute')->value['izin_id'])===null||$tmp==='' ? '' : $tmp);?>
...
?>
    ...
    <!-- khusus perubahan -->
    <?php $_smarty_tpl->tpl_vars['used_by_rute'] = new Smarty_variable($_smarty_tpl->getVariable('m_slot_check')->value->is_slot_used_departure_by_rute(array($_smarty_tpl->getVariable('com_user')->value['airlines_id'],$_smarty_tpl->getVariable('rute')->value['izin_id'],((($_smarty_tpl->getVariable('data')->value->airportCode).('-')).($_smarty_tpl->getVariable('data')->value->nextStation)),$_smarty_tpl->getVariable('data')->value->aircraftType,$_smarty_tpl->getVariable('data')->value->numSeats,$_smarty_tpl->getVariable('data')->value->serviceNoDeparture,((((substr($_smarty_tpl->getVariable('data')->value->clearedTimeDeparture,0,2))).(':')).((substr($_smarty_tpl->getVariable('data')->value->clearedTimeDeparture,2,2)))).(':00'),$_smarty_tpl->getVariable('data')->value->doop,((($tmp = @$_smarty_tpl->getVariable('data')->value->turnaroundDays)===null||$tmp==='' ? '0' : $tmp)),substr($_smarty_tpl->getVariable('data')->value->startDate,0,10),substr($_smarty_tpl->getVariable('data')->value->endDate,0,10))), null, null);?>
    <!-- end of khusus perubahan -->    
...
" readonly="readonly" style="text-align: center;" />
            ...
            <td align='center' width='4%'>
                ...
                <?php }elseif($_smarty_tpl->getVariable('used_by_rute')->value=='0'&&($_smarty_tpl->getVariable('data')->value->serviceNoDeparture==$_smarty_tpl->getVariable('flight_no_existing')->value[1]||$_smarty_tpl->getVariable('data')->value->serviceNoDeparture==$_smarty_tpl->getVariable('flight_no_existing')->value[2])){?>
                <input type="submit" name="save[<?php echo $_smarty_tpl->getVariable('no')->value;?>
]" value="+" class="submit-button" />
                <?php }?>
            </td>
...
?>
    ...
    <?php $_smarty_tpl->tpl_vars['used_by_rute'] = new Smarty_variable($_smarty_tpl->getVariable('m_slot_check')->value->is_slot_used_arrival_by_rute(array($_smarty_tpl->getVariable('com_user')->value['airlines_id'],$_smarty_tpl->getVariable('rute')->value['izin_id'],((($_smarty_tpl->getVariable('data')->value->lastStation).('-')).($_smarty_tpl->getVariable('data')->value->airportCode)),$_smarty_tpl->getVariable('data')->value->aircraftType,$_smarty_tpl->getVariable('data')->value->numSeats,$_smarty_tpl->getVariable('data')->value->serviceNoArrival,((((substr($_smarty_tpl->getVariable('data')->value->clearedTimeArrival,0,2))).(':')).((substr($_smarty_tpl->getVariable('data')->value->clearedTimeArrival,2,2)))).(':00'),$_smarty_tpl->getVariable('data')->value->doop,((($tmp = @$_smarty_tpl->getVariable('data')->value->turnaroundDays)===null||$tmp==='' ? '0' : $tmp)),substr($_smarty_tpl->getVariable('data')->value->startDate,0,10),substr($_smarty_tpl->getVariable('data')->value->endDate,0,10))), null, null);?>
...
" readonly="readonly" style="text-align: center;" />
            ...
            <td align='center' width='8%'>
                ...
                <?php }elseif($_smarty_tpl->getVariable('used_by_rute')->value=='0'&&($_smarty_tpl->getVariable('data')->value->serviceNoArrival==$_smarty_tpl->getVariable('flight_no_existing')->value[1]||$_smarty_tpl->getVariable('data')->value->serviceNoArrival==$_smarty_tpl->getVariable('flight_no_existing')->value[2])){?>
                <input type="submit" name="save[<?php echo $_smarty_tpl->getVariable('no')->value;?>
]" value="+" class="submit-button" />
                <?php }?>
            </td>
