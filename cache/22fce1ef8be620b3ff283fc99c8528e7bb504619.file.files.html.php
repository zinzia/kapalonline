<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:17:05
         compiled from "application/views\izin_internasional/penghentian/files.html" */ ?>
<?php /*%%SmartyHeaderCode:43345600e4510171e1-54895041%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '22fce1ef8be620b3ff283fc99c8528e7bb504619' => 
    array (
      0 => 'application/views\\izin_internasional/penghentian/files.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '43345600e4510171e1-54895041',
  'function' => 
  array (
  ),
...
"><b>Step 2</b><br />Data Izin Rute</a>
        </li>
        <li>
...
<div class="navigation">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['izin_rute_end'];?>
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/penghentian/list_rute/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/penghentian/files_process');?>
...
KB (<?php echo ((mb_detect_encoding($_smarty_tpl->tpl_vars['data']->value['ref_allowed'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['data']->value['ref_allowed'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['data']->value['ref_allowed']));?>
            ...
            <td width="30%">
                ...
                <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/penghentian/files_download/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['ref_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/penghentian/files_next');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
    <table class="table-form" width='100%'>
