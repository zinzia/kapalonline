<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:16:01
         compiled from "application/views\izin_internasional/penghentian/index.html" */ ?>
<?php /*%%SmartyHeaderCode:128845600e411ce5912-00575723%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9f1e6b3faed1d1c509ed62e3c81247610cc8190b' => 
    array (
      0 => 'application/views\\izin_internasional/penghentian/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '128845600e411ce5912-00575723',
  'function' => 
  array (
  ),
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#combobox').change(function() {
            ...
            $.ajax({
                type: 'POST',
                data: 'izin_rute_start=' + izin_rute_start,
                url: '<?php echo $_smarty_tpl->getVariable('config')->value->site_url("izin_internasional/penghentian/get_rute_all_by_rute");?>
',
                complete: function() {
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/penghentian/edit_process');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
" />
    <input type="hidden" name="izin_rute_end" value="<?php echo (($tmp = @((mb_detect_encoding($_smarty_tpl->getVariable('result')->value['izin_rute_end'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('result')->value['izin_rute_end'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('result')->value['izin_rute_end'])))===null||$tmp==='' ? '' : $tmp);?>
" id="input_izin_rute_end" />
...
?>
                    <option value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['izin_rute_start'])===null||$tmp==='' ? '' : $tmp);?>
" <?php if ((($tmp = @$_smarty_tpl->getVariable('result')->value['izin_rute_start'])===null||$tmp==='' ? '' : $tmp)==(($tmp = @$_smarty_tpl->tpl_vars['data']->value['izin_rute_start'])===null||$tmp==='' ? '' : $tmp)){?>selected="selected"<?php }?>><?php echo ((mb_detect_encoding($_smarty_tpl->tpl_vars['data']->value['izin_rute_start'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['data']->value['izin_rute_start'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['data']->value['izin_rute_start']));?>
