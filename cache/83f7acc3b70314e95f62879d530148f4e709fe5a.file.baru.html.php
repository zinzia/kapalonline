<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:41:04
         compiled from "application/views\task/izin_staff_int/baru.html" */ ?>
<?php /*%%SmartyHeaderCode:1875600dbe0b35530-68610541%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83f7acc3b70314e95f62879d530148f4e709fe5a' => 
    array (
      0 => 'application/views\\task/izin_staff_int/baru.html',
      1 => 1441883427,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1875600dbe0b35530-68610541',
  'function' => 
  array (
  ),
...
<div class="navigation" style="background-color: #eee; padding: 10px;">
    <div class="navigation-button" style="width: 850px;">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('task/izin_staff_int/preview_baru/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
