<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 10:07:06
         compiled from "application/views\izin_domestik/perubahan/form_mixed.html" */ ?>
<?php /*%%SmartyHeaderCode:1926156010c2aef19a8-91459551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed4164358d734b1e393756d717f223fcf33d8f2a' => 
    array (
      0 => 'application/views\\izin_domestik/perubahan/form_mixed.html',
      1 => 1442892358,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1926156010c2aef19a8-91459551',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_domestik/perubahan/rute_data_search_process');?>
" method="post">
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_domestik/perubahan/rute_add_process_mixed');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
    <input type="hidden" name="izin_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('rute')->value['izin_id'])===null||$tmp==='' ? '' : $tmp);?>
