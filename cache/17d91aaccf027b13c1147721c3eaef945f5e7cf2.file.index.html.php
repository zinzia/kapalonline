<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:36:27
         compiled from "application/views\izin_pending_internasional/migrasi/index.html" */ ?>
<?php /*%%SmartyHeaderCode:144315600dacbbd82a1-02991258%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17d91aaccf027b13c1147721c3eaef945f5e7cf2' => 
    array (
      0 => 'application/views\\izin_pending_internasional/migrasi/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '144315600dacbbd82a1-02991258',
  'function' => 
  array (
  ),
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/migrasi/index/').($_smarty_tpl->getVariable('detail')->value['izin_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/migrasi/edit_process');?>
" method="post">
