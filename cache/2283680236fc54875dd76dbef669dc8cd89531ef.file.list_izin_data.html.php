<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:54:22
         compiled from "application/views\izin_internasional/perpanjangan/list_izin_data.html" */ ?>
<?php /*%%SmartyHeaderCode:85625600defe971850-31873006%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2283680236fc54875dd76dbef669dc8cd89531ef' => 
    array (
      0 => 'application/views\\izin_internasional/perpanjangan/list_izin_data.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '85625600defe971850-31873006',
  'function' => 
  array (
  ),
...
X</td>
        ...
        <td align="center">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((((('izin_internasional/perpanjangan/izin_data_delete_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['rute_id']));?>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/perpanjangan/form_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
<?php if ($_smarty_tpl->getVariable('rute')->value['is_used_score']==1){?>
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/perpanjangan/form_mixed.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/perpanjangan/form_non_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>