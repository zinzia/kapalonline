<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:41:37
         compiled from "application/views\izin_pending_internasional/baru/files.html" */ ?>
<?php /*%%SmartyHeaderCode:180115600dc0137f566-11381124%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a7926a8521d7f0ba2f57690fdcf4ddd14e2e8a9f' => 
    array (
      0 => 'application/views\\izin_pending_internasional/baru/files.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180115600dc0137f566-11381124',
  'function' => 
  array (
  ),
...
"><b>Step 3</b><br />Slot Clearance</a>
        ...
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/baru/list_files/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<div class="navigation">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['izin_rute_end'];?>
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/baru/list_slot/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/baru/files_process');?>
...
KB (<?php echo ((mb_detect_encoding($_smarty_tpl->tpl_vars['data']->value['ref_allowed'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['data']->value['ref_allowed'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['data']->value['ref_allowed']));?>
            ...
            <td width="30%">
                ...
                <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_pending_internasional/baru/files_download/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['ref_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/baru/files_next');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
    <table class="table-form" width='100%'>
