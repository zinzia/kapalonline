<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 09:57:43
         compiled from "application/views\izin_domestik/perpanjangan/list_izin_data.html" */ ?>
<?php /*%%SmartyHeaderCode:31003560109f7bb0bc7-12872837%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f6b19e417ddffce098ba1cbb2fba80cc137a141' => 
    array (
      0 => 'application/views\\izin_domestik/perpanjangan/list_izin_data.html',
      1 => 1441883441,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31003560109f7bb0bc7-12872837',
  'function' => 
  array (
  ),
...
<div class="navigation">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['izin_rute_end'];?>
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_domestik/perpanjangan/list_rute/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
X</td>
        ...
        <td align="center">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((((('izin_domestik/perpanjangan/izin_data_delete_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['rute_id']));?>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_domestik/perpanjangan/form_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
<?php if ($_smarty_tpl->getVariable('rute')->value['is_used_score']==1){?>
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_domestik/perpanjangan/form_mixed.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_domestik/perpanjangan/form_non_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>