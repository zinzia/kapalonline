<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:31:09
         compiled from "application/views\izin_internasional/migrasi/index.html" */ ?>
<?php /*%%SmartyHeaderCode:232695600d98d887e06-26086057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '76ec76f543d50de36178df5c4c6bd00070e23a51' => 
    array (
      0 => 'application/views\\izin_internasional/migrasi/index.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '232695600d98d887e06-26086057',
  'function' => 
  array (
  ),
...
<div class="step-box">
    <ul>
        <li>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_internasional/migrasi/index/').($_smarty_tpl->getVariable('detail')->value['izin_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/migrasi/edit_process');?>
" method="post">
...
?>
                    <?php if ($_smarty_tpl->getVariable('data')->value->jenis_penerbangan=='Internasional'){?>
