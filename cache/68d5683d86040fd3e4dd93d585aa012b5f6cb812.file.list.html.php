<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:41:32
         compiled from "application/views\izin_pending_internasional/baru/list.html" */ ?>
<?php /*%%SmartyHeaderCode:180735600dbfca35468-50275987%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68d5683d86040fd3e4dd93d585aa012b5f6cb812' => 
    array (
      0 => 'application/views\\izin_pending_internasional/baru/list.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180735600dbfca35468-50275987',
  'function' => 
  array (
  ),
...
<div class="navigation">
 ...
 / <?php echo $_smarty_tpl->getVariable('detail')->value['izin_rute_end'];?>
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/baru/index/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
resource/doc/images/icon/back-icon.png" alt="" />Previous Step</a></li>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('izin_pending_internasional/baru/rute_add_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
...
<br /><?php echo ((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins'), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins'),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['end_date'],'ins')));?>
        ...
        <?php if ($_smarty_tpl->getVariable('rowspan')->value<=1){?>
        <td align="center">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_pending_internasional/baru/rute_data/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id']));?>
" class="button-edit">Edit</a>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_pending_internasional/baru/rute_delete/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_pending_internasional/baru/list_rute_process');?>
" method="post">
