<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:55:19
         compiled from "application/views\izin_internasional/perpanjangan/files.html" */ ?>
<?php /*%%SmartyHeaderCode:35995600df376ce285-52659922%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f629340d5c2781e7598634b0dfcccde3ec54d4c' => 
    array (
      0 => 'application/views\\izin_internasional/perpanjangan/files.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '35995600df376ce285-52659922',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perpanjangan/files_process');?>
...
KB (<?php echo ((mb_detect_encoding($_smarty_tpl->tpl_vars['data']->value['ref_allowed'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['data']->value['ref_allowed'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['data']->value['ref_allowed']));?>
            ...
            <td width="30%">
                ...
                <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('izin_internasional/perpanjangan/files_download/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['ref_id']));?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('izin_internasional/perpanjangan/files_next');?>
" method="post">
    <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
    <table class="table-form" width='100%'>
