<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 06:44:41
         compiled from "application/views\task/izin_direktur_int/baru.html" */ ?>
<?php /*%%SmartyHeaderCode:152145600dcb95d0d57-61506756%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '640ca4d09787d17bcaf53eb3d502dd81bf315c74' => 
    array (
      0 => 'application/views\\task/izin_direktur_int/baru.html',
      1 => 1441883426,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '152145600dcb95d0d57-61506756',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('task/izin_direktur_int/approved_process');?>
" method="post">
...
<br /><?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['end_date'])===null||$tmp==='' ? '' : $tmp);?>
            ...
            <td align="center" rowspan="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['rowspan'])===null||$tmp==='' ? '0' : $tmp);?>
">
                <p><?php if ($_smarty_tpl->tpl_vars['data']->value['izin_approval']=='approved'){?>VALID<?php }else{ ?><?php echo ((mb_detect_encoding($_smarty_tpl->tpl_vars['data']->value['izin_approval'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['data']->value['izin_approval'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['data']->value['izin_approval']));?>
<?php }?></p>
                <p style="color:red;"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['data']->value['notes'])===null||$tmp==='' ? '' : $tmp);?>
</p>
            </td>
            <?php }?>
        </tr>
...
?>
 ...
 / <?php echo $_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['data']->value['note_date']);?>
        ...
        <td width="33%" style="vertical-align: top;">
            <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('task/izin_direktur_int/catatan_process/');?>
" method="post">
                <input type="hidden" name="registrasi_id" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('detail')->value['registrasi_id'])===null||$tmp==='' ? '' : $tmp);?>
">
...
?>
                    <li style="border-bottom: 1px solid #ddd;">
                        <span><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_direktur_int/delete_memo_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['memo_id']));?>
    ...
    <tr style="font-weight: bold;">
        <td width="40%" style="vertical-align: top;">
            ...
            <p style="font-weight: normal;">
                Telah diupload : <br /><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('task/izin_rute_int/telaah_download/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
...
<div class="navigation" style="background-color: #eee; padding: 10px;">
    <div class="navigation-button" style="width: 850px;">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('task/izin_direktur_int/preview_baru/').($_smarty_tpl->getVariable('detail')->value['registrasi_id']));?>
"><img src="<?php echo $_smarty_tpl->getVariable('BASEURL')->value;?>
resource/doc/images/icon/icon.normal.png" alt="" /> Preview Surat</a></li>
            ...
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_direktur_int/back_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->getVariable('detail')->value['process_id']));?>
...
resource/doc/images/icon/arrow-left.png" alt="" /> Kirim ke <?php echo $_smarty_tpl->getVariable('prev')->value['role_nm'];?>
            ...
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_direktur_int/reject_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->getVariable('detail')->value['process_id']));?>
...
resource/doc/images/icon/icon.failed.png" alt="" /> Tolak Semua Permohonan</a></li>
            ...
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_direktur_int/send_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->getVariable('detail')->value['process_id']));?>
...
resource/doc/images/icon/arrow-right.png" alt="" /> Kirim ke <?php echo $_smarty_tpl->getVariable('next')->value['role_nm'];?>
            ...
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('task/izin_direktur_int/finish_baru_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->getVariable('detail')->value['process_id']));?>
