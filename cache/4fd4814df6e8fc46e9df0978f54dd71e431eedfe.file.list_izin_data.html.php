<?php /* Smarty version Smarty-3.0.7, created on 2015-09-22 07:19:21
         compiled from "application/views\izin_internasional/perubahan/list_izin_data.html" */ ?>
<?php /*%%SmartyHeaderCode:229745600e4d9c31be6-84713785%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4fd4814df6e8fc46e9df0978f54dd71e431eedfe' => 
    array (
      0 => 'application/views\\izin_internasional/perubahan/list_izin_data.html',
      1 => 1442894814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '229745600e4d9c31be6-84713785',
  'function' => 
  array (
  ),
...
X</td>
        ...
        <td align="center">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((((('izin_internasional/perubahan/izin_data_delete_process/').($_smarty_tpl->getVariable('detail')->value['registrasi_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['izin_id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['rute_id']));?>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/perubahan/form_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
<?php if ($_smarty_tpl->getVariable('rute')->value['is_used_score']==1){?>
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/perubahan/form_mixed.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>
...
<!-- include html -->
<?php $_template = new Smarty_Internal_Template("izin_internasional/perubahan/form_non_iasm.html", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
<!-- end of include html -->
<?php }?>