<?php /* Smarty version Smarty-3.0.7, created on 2015-12-01 10:33:58
         compiled from "application/views\member/published_izin/index.html" */ ?>
<?php /*%%SmartyHeaderCode:19154565d6986c26603-43430522%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ee6d3dcaa1c96f61445b71ace5d398e25de1ceb' => 
    array (
      0 => 'application/views\\member/published_izin/index.html',
      1 => 1443841845,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19154565d6986c26603-43430522',
  'function' => 
  array (
  ),
...
<div class="search-box">
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('member/published_izin/proses_cari');?>
" method="post">
...
.</td>
        <td align="center"><?php echo ((mb_detect_encoding($_smarty_tpl->tpl_vars['result']->value['izin_published_letter'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['result']->value['izin_published_letter'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['result']->value['izin_published_letter']));?>
</td>
        <td align="center"><?php echo ((mb_detect_encoding($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['result']->value['izin_published_date'],'ins'), 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['result']->value['izin_published_date'],'ins'),SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable('dtm')->value->get_full_date($_smarty_tpl->tpl_vars['result']->value['izin_published_date'],'ins')));?>
</td>
...
<br /><?php echo ((mb_detect_encoding($_smarty_tpl->tpl_vars['result']->value['group_nm'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['result']->value['group_nm'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['result']->value['group_nm']));?>
        ...
        <td align="center">
            ...
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url((($tmp = @((('member/published_izin/').($_smarty_tpl->tpl_vars['result']->value['group_alias'])).('/')).($_smarty_tpl->tpl_vars['result']->value['registrasi_id']))===null||$tmp==='' ? '' : $tmp));?>
