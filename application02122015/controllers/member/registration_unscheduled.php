...
class registration_unscheduled extends ApplicationBase {
    ...
    public function __construct() {
        ...
        if (!in_array("tidak berjadwal", $data)) {
            // notification
            $this->tnotification->sent_notification("error", "Anda Tidak Dapat Melakukan Registrasi Tidak Berjadwal");
            redirect('member/welcome');
        }
    }
    ...
    public function create() {
        ...
        if (!empty($id)) {
            ...
            redirect('member/registration_unscheduled/add/' . $id);
        } else {
            // notification
            $this->tnotification->sent_notification("error", "An unexpected error has occurred");
            redirect('member/registration_unscheduled');
        }
    }
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "member/registration_unscheduled/list.html");
        // list opened form
        $rs_id = $this->m_registration->get_list_registration_open(array('tidak berjadwal', $this->com_user['airlines_id']));
        $data = array();
    ...
    public function add($data_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "member/registration_unscheduled/add.html");
        // load javascript
    ...
    public function add_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_registration->update($params, $where)) {
                ...
                // default redirect
                redirect("member/registration_unscheduled/form/" . $this->input->post('data_id'));
            } else {
                // default error
        ...
        // default redirect
        redirect("member/registration_unscheduled/add/" . $this->input->post('data_id'));
    }
    ...
    public function form($data_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "member/registration_unscheduled/form.html");
        // load javascript
    ...
    public function form_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_registration->update($params, $where)) {
                ...
                $this->tnotification->sent_notification("success", "Data berhasil disimpan!");
                // default redirect
                redirect("member/registration_unscheduled/files/" . $this->input->post('data_id'));
            } else {
                // default error
                $this->tnotification->sent_notification("error", "Data gagal disimpan");
            }
    ...
    public function files($data_id = "") {
        ...
        // set template content
        $this->smarty->assign("template_content", "member/registration_unscheduled/files.html");
        // get detail data
        $params = array($data_id, $this->com_user['airlines_id']);
        $result = $this->m_registration->get_detail_data_by_id($params);
        if (empty($result)) {
    ...
    public function files_process() {
        ...
        // default redirect
        redirect("member/registration_unscheduled/files/" . $data_id);
    }
    ...
    public function send_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($result['data_completed'] == '1') {
                ...
                $doc_no = $this->m_registration->get_document_number_tidak_berjadwal($code);
    ...
    public function disclaimer() {
        ...
        // set template content
        $this->smarty->assign("template_content", "member/registration_unscheduled/disclaimer.html");
        // get disclaimer list
    ...
    public function disclaimer_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->session->userdata('word') == $captcha AND $this->session->userdata('ip_address') == $_SERVER["REMOTE_ADDR"] AND $this->session->userdata('captcha_time') > $expiration) {
                ...
                $this->tnotification->sent_notification("success", "Data berhasil disimpan");
                // redirect
                redirect("member/registration_unscheduled/create/");
            } else {
        ...
        // redirect
        redirect("member/registration_unscheduled/disclaimer/");
    }
