...
class pembayaran_auntb extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "task/pembayaran_auntb/index.html");
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("task/pembayaran_auntb/index/");
        $config['total_rows'] = $this->m_pembayaran->get_total_awaiting_task_selain_berjadwal(array($published_no, $airlines_nm, "berjadwal"));
        ...
        $this->smarty->assign("rs_id", $this->m_pembayaran->get_list_awaiting_task_selain_berjadwal($params));
        // notification
    ...
    public function proses_cari() {
        ...
        // redirect
        redirect("task/pembayaran_auntb");
    }
    ...
    function form_pembayaran() {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/pembayaran_auntb/form.html");
        // published no
        $x = 1;
    ...
    function pembayaran_process($data_id) {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            // redirect
            redirect("task/pembayaran_auntb/form_pembayaran/");
        }
        // redirect
        redirect("task/pembayaran_auntb/cetak_pembayaran/" . $this->input->post('payment_invoice'));
    }
    ...
    function cetak_pembayaran($payment_invoice) {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/pembayaran_auntb/invoice.html");
        // detail invoice
