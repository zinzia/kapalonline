...
class fa_aunbdn_kasubdit extends ApplicationBase {
    ...
    public function index($data_id = "") {
        ...
        $this->smarty->assign("template_content", "task/fa_aunbdn_kasubdit/detail.html");
        // get detail task
    ...
    public function edit_process() {
        ...
        // default redirect
        redirect("task/fa_aunbdn_kasubdit/index/" . $data_id);
    }
    ...
    public function finish_process($data_id = "", $process_id = "") {
        ...
        $trim = "5";
        // get fa group
        $group = $this->m_task->get_fa_group('1');
        // update
        $params = array('approve', 'done', $this->com_user['user_id'], $process_id);
        if ($this->m_task->action_update($params)) {
            // total registration
