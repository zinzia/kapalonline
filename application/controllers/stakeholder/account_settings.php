...
class account_settings extends ApplicationBase {
    ...
    public function data_pribadi() {
        ...
        $this->smarty->assign("template_content", "stakeholder/welcome/index.html");
        // load javascript
    ...
    public function process_data_pribadi() {
        ...
        // default redirect
        redirect("stakeholder/account_settings/data_pribadi");
    }
    ...
    public function user_account() {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "stakeholder/welcome/account.html");
        // get data pribadi
    ...
    public function process_update_account() {
        ...
        // default redirect
        redirect("stakeholder/account_settings/user_account");
    }
    ...
    public function change_role() {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "stakeholder/welcome/role.html");
        // get data role
        $this->smarty->assign("rs_roles", $this->m_account->get_all_roles_by_users(array(9, $this->com_user['user_id'])));
        // notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
        // output
    ...
    public function process_update_role() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            // get user login
            $session = $this->tsession->userdata('session_pk_stakeholder');
            $this->tsession->set_userdata('session_pk_stakeholder', array('user_id' => $session['user_id'], 'role_id' => $this->input->post('role_id')));
            // notification
            $this->tnotification->delete_last_field();
            $this->tnotification->sent_notification("success", "Data berhasil disimpan");
        } else {
        ...
        // default redirect
        redirect("stakeholder/account_settings/change_role");
    }
