...
class fa_aubnln_kasi extends ApplicationBase {
    ...
    public function index($data_id = "") {
        ...
        $this->smarty->assign("template_content", "task/fa_aubnln_kasi/detail.html");
        // get detail task
    ...
    public function edit_process() {
        ...
        // default redirect
        redirect("task/fa_aubnln_kasi/index/" . $data_id);
    }
