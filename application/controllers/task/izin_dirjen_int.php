...
class izin_dirjen_int extends ApplicationBase {
    ...
    public function baru($registrasi_id = "") {
        ...
        $this->smarty->assign("template_content", "task/izin_dirjen_int/baru.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_dirjen_int/baru");
        // load javascript
    ...
    public function frekuensi_add($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_dirjen_int/frekuensi_add.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_dirjen_int/frekuensi_add");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function frekuensi_delete($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_dirjen_int/frekuensi_delete.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_dirjen_int/frekuensi_delete");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function perpanjangan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_dirjen_int/perpanjangan.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_dirjen_int/perpanjangan");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function penghentian($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_dirjen_int/penghentian.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_dirjen_int/penghentian");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function pencabutan_all($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_dirjen_int/pencabutan_all.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_dirjen_int/pencabutan_all");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function pencabutan_rute($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_dirjen_int/pencabutan_rute.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_dirjen_int/pencabutan_rute");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function back_process($registrasi_id = "", $process_id = "") {
        ...
        // default redirect
        redirect("task/izin_dirjen_int/" . $detail['group_alias'] . "/" . $registrasi_id);
    }
