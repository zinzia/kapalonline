...
class fa_auntbdn_kasi extends ApplicationBase {
    ...
    public function index($data_id = "") {
        ...
        $this->smarty->assign("template_content", "task/fa_auntbdn_kasi/detail.html");
        // get detail task
    ...
    public function edit_process() {
        ...
        // default redirect
        redirect("task/fa_auntbdn_kasi/index/" . $data_id);
    }
