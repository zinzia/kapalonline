...
class izin_kasi_int extends ApplicationBase {
    ...
    public function baru($registrasi_id = "") {
        ...
        $this->smarty->assign("template_content", "task/izin_kasi_int/baru.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/baru");
        // load javascript
    ...
    public function penundaan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/penundaan.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/penundaan");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function perubahan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/perubahan.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/perubahan");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function frekuensi_add($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/frekuensi_add.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/frekuensi_add");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function frekuensi_delete($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/frekuensi_delete.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/frekuensi_delete");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function perpanjangan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/perpanjangan.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/perpanjangan");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function penghentian($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/penghentian.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/penghentian");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function pencabutan_all($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/pencabutan_all.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/pencabutan_all");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function pencabutan_rute($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_kasi_int/pencabutan_rute.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_kasi_int/pencabutan_rute");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function approved_process() {
        ...
        // default redirect
        redirect("task/izin_kasi_int/" . $result['group_alias'] . "/" . $registrasi_id);
    }
    ...
    public function back_process($registrasi_id = "", $process_id = "") {
        ...
        // default redirect
        redirect("task/izin_kasi_int/" . $detail['group_alias'] . "/" . $registrasi_id);
    }
    ...
    // revisi pencabutan
    public function revisi_pencabutan_process($registrasi_id = "", $process_id = "") {
        // set page rules
        $this->_set_page_rule("U");
        // get task
        $detail = $this->m_task->get_detail_registrasi_waiting_by_id(array($registrasi_id, $this->com_user['role_id']));
        ...
        // params
        $params = array(
            'izin_request_letter' => NULL,
            'izin_request_letter_date' => NULL,
            'izin_request_st' => '0',
            'izin_request_date' => NULL,
        );
        $where = array(
            'registrasi_id' => $registrasi_id,
        );
        if ($this->m_task->registrasi_done_process($params, $where)) {
            // update
            $params = array('reject', 'done', $this->com_user['user_id'], $process_id);
