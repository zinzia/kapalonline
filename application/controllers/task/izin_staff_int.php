...
class izin_staff_int extends ApplicationBase {
    ...
    public function migrasi($registrasi_id = "") {
        ...
        $this->smarty->assign("template_content", "task/izin_staff_int/migrasi.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/migrasi");
        // load javascript
         ...
         * ACTION
         */
        $action = $this->m_task->get_action_control(array($this->com_user['role_id'], 30));
    ...
    public function baru($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_staff_int/baru.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/baru");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function penundaan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_staff_int/penundaan.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/penundaan");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function perubahan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_staff_int/perubahan.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/perubahan");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function frekuensi_add($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_staff_int/frekuensi_add.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/frekuensi_add");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function frekuensi_delete($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_staff_int/frekuensi_delete.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/frekuensi_delete");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function perpanjangan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_staff_int/perpanjangan.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/perpanjangan");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function penghentian($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "task/izin_staff_int/penghentian.html");
        // url path
        $this->smarty->assign("url_path", "task/izin_staff_int/penghentian");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript("resource/js/select2-3.4.5/select2.min.js");
        // load style ui
    ...
    public function approved_process() {
        ...
        // default redirect
        redirect("task/izin_staff_int/" . $result['group_alias'] . "/" . $registrasi_id);
    }
    ...
    public function finish_migrasi_process($registrasi_id = "", $process_id = "") {
        ...
        if ($this->m_task->action_update($params)) {
            ...
            if ($detail['kode_izin'] != "") {
                ...
                $kode_izin = $this->m_task->get_kode_izin_internasional(array($detail['airlines_id'], 'internasional'));
            }
