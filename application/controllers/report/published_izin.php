...
class published_izin extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "report/published_izin/index.html");
        // get tahun
        $this->smarty->assign("rs_tahun", $this->m_published_izin->get_list_tahun_report());
        // bulan
        $bulan = array(
            '01' => 'Januari',
            '02' => 'Februari',
        ...
        /* start of pagination --------------------- */
        // pagination
        $config['base_url'] = site_url("report/published_izin/index/");
        $config['total_rows'] = $this->m_published_izin->get_total_finished_izin_registrasi(array($tahun, $bulan, $data_flight, $payment_st));
        ...
        $rs_id = $this->m_published_izin->get_list_finished_izin_registrasi($params);
    ...
    public function baru($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/baru.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
    ...
    public function perpanjangan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/perpanjangan.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
    ...
    public function penundaan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/penundaan.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
    ...
    public function penghentian($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/penghentian.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
...
//        }
    ...
    public function frekuensi_add($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/frekuensi_add.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
    ...
    public function frekuensi_delete($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/frekuensi_delete.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
    ...
    public function perubahan($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/perubahan.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
...
//         exit;
    ...
    public function frekuensi($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/frekuensi.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
    ...
    public function notam($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/notam.html");
        /*
         * REGISTRASI
         */
        // detail registrasi
    ...
    public function migrasi($registrasi_id = "") {
        ...
        $this->_set_page_rule("R");
        // set template content
        $this->smarty->assign("template_content", "report/published_izin/migrasi.html");
        // get detail data
        ...
        $notes = array();
        $data = array();
        $rs_id = $this->m_published_izin->get_list_izin_rute_by_id(array($registrasi_id, $result['airlines_id']));
        $no = 1;
        foreach ($rs_id as $izin_rute) {
            $izin_data = $this->m_published_izin->get_list_izin_data_by_id(array($izin_rute['izin_id']));
            if (!empty($izin_data)) {
        ...
        $this->smarty->assign("notes", $notes);
        // get total frekuensi
        $this->smarty->assign("total", $this->m_published_izin->get_total_frekuensi_by_registrasi_id($registrasi_id));
        ...
        // total frek
        //$this->smarty->assign("tot_frek", $this->m_published_izin->get_total_frekuensi(array($registrasi_id)));
        // output
        parent::display();
    }
    ...
    public function download_migrasi($registrasi_id = "") {
        ...
        $rs_id = $data;
        // get total frekuensi
        $total = $this->m_published_izin->get_total_frekuensi_by_registrasi_id($registrasi_id);
