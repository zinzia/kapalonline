...
class domestik extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "pencabutan/domestik/registrasi.html");
        // list draft
        $rs_id = $this->m_registrasi->get_list_draft_registrasi(array('domestik'));
