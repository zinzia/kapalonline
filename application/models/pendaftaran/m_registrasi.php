...
class m_registrasi extends CI_Model {
    ...
    // list all jenis kapal
    function get_bendera_asal() {
    ...
    // list all jenis kapal
    function get_jenis_kapal() {
        $sql = "SELECT a.*, b.jenis_ket FROM daftar_jenisdetail_kapal a 
				LEFT JOIN  daftar_jenis_kapal b ON a.jenis_id = b.jenis_id
    ...
    function create_group_data($params) {
        ...
        // insert
        $sql = "INSERT INTO daftar_registrasi (registrasi_id, daftar_group, no_surat, tgl_surat, request_by, nama_pemohon, pemilik_st, bukti_hakmilik, pelabuhan_id, mdb, mdd)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
    ...
    function get_izin_rute_waiting_by_id($params) {
